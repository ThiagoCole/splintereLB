...
Personally I count on a debit card and a cellphone (and frequently, Mrs. Average Joe Cyclist). I understand a man who cannot also walk without assistance, but he can ride a bike. He posesses cell mobile and a debit card, hence if the bike reduces, he has an out. I was biking with him once when that took place, and within 10 minutes he and his cycle experienced disappeared in a cab! If you like to carry tools and fix things like a flat tire, check out this video that shows how straightforward fixing a set can be:
